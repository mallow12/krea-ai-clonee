...
const galleryItems = [
  {
    id: 1,
    title: "Quantum Nexus",
    prompt: "Interconnected quantum particles forming neural networks in digital space",
    style: "Digital Art",
    likes: 2847,
    views: 15234,
    author: "@code_alchemist",
  ...
  },
  {
    ...
    prompt: "Bioluminescent synapses firing through an organic AI consciousness",
    style: "Bio-Tech Art",
    likes: 1923,
    views: 8765,
    author: "@synapse_sculptor",
  ...
  },
  {
    id: 3,
    title: "Data Streams",
    prompt: "Cascading information flows through a matrix of pure computational energy",
    style: "Cyberpunk",
    likes: 3421,
    views: 18902,
    author: "@binary_poet",
  ...
  },
  {
    ...
    prompt: "Surreal landscapes generated by sleeping artificial intelligence",
    style: "Surreal AI",
    likes: 2156,
    views: 11543,
    author: "@logic_weaver",
  ...
  },
  {
    ...
    prompt: "Living code transforming into crystalline structures of pure logic",
    style: "Abstract Tech",
    likes: 1687,
    views: 7892,
    author: "@function_artist",
  ...
  },
  {
    ...
    prompt: "Organic forms evolving through digital transformation processes",
    style: "Bio-Digital",
    likes: 2934,
    views: 14567,
    author: "@transform_dev",
